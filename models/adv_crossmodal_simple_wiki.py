...
class ModelParams(BaseModelParams):
    def __init__(self):
        ...
        self.checkpoint_dir = '/home/media/Downloads/ACMR_demo_master/checkpoint'
        self.sample_dir = '/home/media/Downloads/ACMR_demo_master/samples'
        self.dataset_dir = '/home/media/Downloads/ACMR_demo_master/data'
        self.log_dir = '/home/media/Downloads/ACMR_demo_master/logs'
...
class AdvCrossModalSimple(BaseModel):
        ...
        for epoch in range(self.model_params.epoch):
            if epoch % 1 ==0:
                ...
                for feats, vecs, labels, i in self.data_iter.train_data():
                    ...
                    #标签二值化，http://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.LabelBinarizer.html
                ...
                #print("test_img_feats_trans is", test_img_feats_trans)
                #print("test_txt_vecs_trans is", test_txt_vecs_trans[0])
                ...
                for i in range(len(test_txt_vecs_trans)):
                    ...
                    #print("sorted_idx is", sorted_idx)
                    # for each k do top-k
                    precs = []
            ...
            if epoch == (self.model_params.epoch-1):
                with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/map_avg_ti.pkl', 'wb') as f:
                    cPickle.dump(map_avg_ti, f, cPickle.HIGHEST_PROTOCOL)
                with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/map_avg_it.pkl', 'wb') as f:
                    cPickle.dump(map_avg_it, f, cPickle.HIGHEST_PROTOCOL)
                with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/adv_loss.pkl', 'wb') as f:
                    cPickle.dump(adv_loss, f, cPickle.HIGHEST_PROTOCOL)
                with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/emb_loss.pkl', 'wb') as f:
            ...
            if epoch==0:
                ...
                with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/before_feats_transformed.pkl', 'wb') as f:
            ...
            for batch_feat, batch_vec, batch_labels, idx in self.data_iter.train_data():
                ...
                label_loss_val, similar_loss_val, emb_loss_val, domain_loss_val, dissimilar_loss_val= sess.run([self.label_loss, self.similar_loss, self.emb_loss, self.domain_class_loss, self.dissimilar_loss],
                                                         feed_dict={self.visual_feats: batch_feat,
                                                                    ...
                                                                    self.l: l})
                iteration.append(epoch * 33 + idx)
                Label_loss.append(label_loss_val)
                Similar_loss.append(similar_loss_val)
                Emb_loss.append(emb_loss_val)
                Dissimilar_loss.append(dissimilar_loss_val)
                Domain_loss.append(domain_loss_val)
            ...
            if (epoch + 1) % 10 == 0:
                plt.plot(iteration, Label_loss, 'r-', label = 'Label_loss')
                plt.plot(iteration, Similar_loss, 'b-', label = 'Similar_loss')
                plt.plot(iteration, Emb_loss, 'g-', label = 'Emb_loss')
                plt.plot(iteration, Dissimilar_loss, 'y-', label = 'Dissimilar_loss')
                plt.plot(iteration, Domain_loss, 'c-', label = 'Domain_loss')
                plt.legend(loc=0)

                plt.savefig('/home/media/Downloads/ACMR_demo_master/graph/'+'epoch%d' % epoch+'.png')
                plt.close()
            iteration_epoch.append(epoch)
            Label_loss_epoch.append(np.mean(Label_loss[epoch*33:(epoch+1)*33]))
            Similar_loss_epoch.append(np.mean(Similar_loss[epoch*33:(epoch+1)*33]))
            Emb_loss_epoch.append(np.mean(Emb_loss[epoch*33:(epoch+1)*33]))
            Dissimilar_loss_epoch.append(np.mean(Dissimilar_loss[epoch*33:(epoch+1)*33]))
            Domain_loss_epoch.append(np.mean(Domain_loss[epoch*33:(epoch+1)*33]))
            plt.plot(iteration_epoch, Label_loss_epoch, 'r-', label = 'Label_loss')
            plt.plot(iteration_epoch, Similar_loss_epoch, 'b-', label = 'Similar_loss')
            plt.plot(iteration_epoch, Emb_loss_epoch, 'g-', label = 'Emb_loss')
            plt.plot(iteration_epoch, Dissimilar_loss_epoch, 'y-', label = 'Dissimilar_loss')
            plt.plot(iteration_epoch, Domain_loss_epoch, 'c-', label = 'Domain_loss')
            plt.legend(loc=0)

            plt.savefig('/home/media/Downloads/ACMR_demo_master/graph/'+'total.png')
            plt.close()
    ...
    def eval_random_rank(self):
        start = time.time()
        with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/test_labels.pkl', 'rb') as fpkl:
            test_labels = cPickle.load(fpkl)
        #with open('/home/media/Downloads/ACMR_demo_master/data/wiki_shallow/L_te.pkl', 'rb') as fpkl:
            #test_labels = cPickle.load(fpkl)
        k = self.model_params.top_k
        avg_precs = []
    ...
    def eval(self, sess):
        ...
        test_txt_vecs_trans = np.asarray(test_txt_vecs_trans)
        test_feats_trans = np.concatenate((test_img_feats_trans[0:1000], test_txt_vecs_trans[-1000:]))
        with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/test_feats_transformed.pkl', 'wb') as f:
            cPickle.dump(test_feats_trans, f, cPickle.HIGHEST_PROTOCOL)
        #with open('/home/media/Downloads/ACMR_demo_master/data/wiki_shallow/test_feats_transformed.pkl', 'wb') as f:
            #cPickle.dump(test_feats_trans, f, cPickle.HIGHEST_PROTOCOL)
        ...
        all_k =[50]
        #print("length is", len(test_txt_vecs_trans))
        for k in all_k:
            for i in range(len(test_txt_vecs_trans)):
                query_label = test_labels[i]
                ...
                for topk in range(1, k + 1):
                    hits = 0
                    top_k = sorted_idx[0 : topk]
                    #print("query_label is", query_label)
                    #print("query_label sum is", np.sum(query_label))
        ...
        t2i = all_precs[0]
        with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/txt2img_all_precision.pkl', 'wb') as f:
            cPickle.dump(all_precs, f, cPickle.HIGHEST_PROTOCOL)
        #with open('/home/media/Downloads/ACMR_demo_master/data/wiki_shallow/txt2img_all_precision.pkl', 'wb') as f:
            #cPickle.dump(all_precs, f, cPickle.HIGHEST_PROTOCOL)
        ...
        with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/text_words_map.pkl', 'wb') as f:
            cPickle.dump(all_precs, f, cPickle.HIGHEST_PROTOCOL)
        #with open('/home/media/Downloads/ACMR_demo_master/data/wiki_shallow/text_words_map.pkl', 'wb') as f:
            #cPickle.dump(all_precs, f, cPickle.HIGHEST_PROTOCOL)
        #Text query
        ...
        with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/text_words_map.pkl', 'rb') as f:
            txt_words = cPickle.load(f)
        with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/test_img_words.pkl', 'rb') as f:
            img_words = cPickle.load(f)
        with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/test_txt_files.pkl', 'rb') as f:
            test_txt_names = cPickle.load(f)
        with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/test_img_files.pkl', 'rb') as f:
            test_img_names = cPickle.load(f)
        ...
        with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/txt2img-retrievals.pkl', 'wb') as f:
        ...
        with open('/home/media/Downloads/ACMR_demo_master/data/wikipedia_dataset/img2txt-retrievals.pkl', 'wb') as f:
            cPickle.dump(retrieval_results, f, cPickle.HIGHEST_PROTOCOL)
